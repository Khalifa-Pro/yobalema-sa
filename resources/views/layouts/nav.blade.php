...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
   ...
   <a href="{{route('alert.liste')}}" style="background-color: white; border-radius: 7%; border: 1px solid white; width: 80px; height: 45px;">
    <button class="btn btn-outline-danger" style="margin-top: 5px;margin-left:17px;">
