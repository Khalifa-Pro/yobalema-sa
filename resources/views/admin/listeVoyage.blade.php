  ...
  <div class="container-fluid px-4">
      <div class="card mb-4">
           <div class="card-header bg-dark">
               ...
               <span style="color:aliceblue">Liste des voyages</span>
           </div>
          <div class="card-body">
              <table id="datatablesSimple">
                  ...
                  <tbody>
                      @foreach ($liste as $location)
                      <tr>
                          <td>{{$location->nom_complet_client}}</td>
                          <td>{{$location->telephone}}</td>
                          <td>{{$location->pointDepart}}</td>
                          <td>{{$location->pointArrivee}}</td>
                          <td>{{$location->dateVoyage}}</td>
                          <td>{{$location->heureDepart}} H</td>
                          <td>
                               {{-- <a style="text-decoration: none" href="{{ route('modifier.candidat',['id' => $candidat->id_candidat])}}"> --}}
                                   ...
                                   <a style="text-decoration: none" href=" {{route('admin.supprimerVoyage',['id' => $location->id_location])}} ">
